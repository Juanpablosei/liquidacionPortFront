      ...
      <div className="bg-card border border-border rounded-2xl p-8 w-full max-w-md mx-4 shadow-2xl">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            <label htmlFor="fp-new" className="text-sm font-medium text-muted-foreground">
              {txt.newPassword}
            </label>
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="fp-confirm" className="text-sm font-medium text-muted-foreground">
              {txt.confirmPassword}
            </label>
            <div className="relative">
              <input
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="mt-2 h-11 w-full rounded-xl bg-brand hover:bg-brand-hover text-white text-sm font-medium transition-all hover:shadow-[0_0_24px_rgba(37,99,235,0.4)] active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {isLoading ? (
              <>
