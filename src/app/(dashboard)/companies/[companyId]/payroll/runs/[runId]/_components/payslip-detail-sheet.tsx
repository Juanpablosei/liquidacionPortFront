  ...
  return (
    <div className="mb-3">
      ...
      <div className="flex flex-col gap-1">
        {lines.map((line) => (
          <div key={line.id} className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-overlay-subtle focus-within:bg-overlay-subtle group">
            ...
            {editingLine === line.id ? (
              <div className="flex items-center gap-1.5">
                <input
                  ...
                  className="w-28 px-2 py-1 rounded bg-overlay-strong border border-border text-foreground text-xs font-mono focus:outline-none focus:border-brand/50"
                  autoFocus
                />
                <button
                ...
                <button
                  ...
                  className="min-w-[44px] min-h-[44px] flex items-center justify-center rounded text-muted-foreground hover:text-red-400 hover:bg-red-500/10 transition-colors duration-150 cursor-pointer"
                >
              ...
              <div className="flex items-center gap-1.5">
                ...
                {canEdit && (
                  <button
                    ...
                    className="opacity-0 group-hover:opacity-100 focus-visible:opacity-100 min-w-[44px] min-h-[44px] flex items-center justify-center rounded text-muted-foreground hover:text-foreground hover:bg-overlay transition-all duration-150 cursor-pointer focus-visible:ring-2 focus-visible:ring-brand/50 focus-visible:outline-none"
                  >
              ...
              <div className="p-4 flex flex-col gap-4">
                ...
                <div className="rounded-xl bg-overlay-subtle border border-border divide-y divide-border">
                  ...
                  <div className="flex items-center justify-between px-4 py-3">
                    <span className="text-sm font-semibold text-foreground">{labels.netPayable}</span>
