...
export function CategorySheet({ open, onOpenChange, onSubmit, editItem, isSaving }: CategorySheetProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        className="w-[400px] max-w-[100vw] bg-sidebar border-l border-border text-foreground overflow-y-auto"
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 p-4">
          <div className="grid grid-cols-2 gap-3">
            ...
            <FormField label={t.convenios.sortOrder} name="catSortOrder" error={errors.sortOrder?.message}>
              <Input
                type="number" min={0}
          ...
          <div className="grid grid-cols-2 gap-3">
            <FormField label={t.convenios.baseSalary} name="baseSalary" error={errors.baseSalary?.message} required>
              <Input
            ...
            <FormField label={t.convenios.hourlyRate} name="hourlyRate" error={errors.hourlyRate?.message} required>
              <Input
                type="number" step="0.01" min="0.01"
